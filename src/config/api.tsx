...
export const watchCoinDataApi = (
  ...
  `https://api.coingecko.com/api/v3/coins/markets?ids=${coinIds.join(",")}&vs_currency=${currency}&per_page=${perPage}&page=${page}&order=${filter}&price_change_percentage=1h%2C24h%2C7d&precision=2`;
